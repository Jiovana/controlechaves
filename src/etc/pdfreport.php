...
/*
* GERA RELATORIOS DE MOVIMENTACOES EM PDF
* utiliza o plugin FPDF para gerar uma tabela contendo os logs de movimentacoes de um periodo
*/

$control = new ControlLog();

//as datas sao enviadas via GET na url
